...
import { useAuth } from '../../context/AuthContext';
 // Assuming SidebarLink is now in a separate file
  ...
  return (
    <div className="w-64 flex-shrink-0 bg-gradient-to-b from-white via-green-25 to-blue-50 border-r border-green-100/50 text-gray-700 p-6 shadow-lg">
      ...
      <nav className="space-y-3">
        ...
        <SidebarLink to="/pharmacy/prescription" icon={FaMoneyBill} text="Prescription" />
        <SidebarLink to="/pharmacy/medicine-stock" icon={FaUsers} text="Medicine Stock" />
